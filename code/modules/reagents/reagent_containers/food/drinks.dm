...
/obj/item/reagent_containers/food/drinks/use_before(mob/M, mob/user)
	if (!istype(M))
		return FALSE
...
/obj/item/reagent_containers/food/drinks/examine(mob/user, distance)
	...
	else if (total_volume <= reagents_volume * 0.25)
		to_chat(user, SPAN_NOTICE("\The [src] is almost empty!"))
	else if (total_volume <= reagents_volume * 0.66)
		to_chat(user, SPAN_NOTICE("\The [src] is half full!"))
	else if (total_volume <= reagents_volume * 0.90)
...
/obj/item/reagent_containers/food/drinks/milk
	...
	reagents = list(/datum/reagent/drink/milk = 50)
...
/obj/item/reagent_containers/food/drinks/bottle/thoom
	...
	can_shatter = FALSE
	reagents = list(/datum/reagent/drink/thoom = 50)
...
/obj/item/reagent_containers/food/drinks/soymilk
	...
	item_state = "carton"
	center_of_mass = "x=16;y=9"
	reagents = list(/datum/reagent/drink/milk/soymilk = 50)
...
/obj/item/reagent_containers/food/drinks/small_milk
	...
	center_of_mass = "x=16;y=9"
	reagents_volume = 30
	reagents = list(/datum/reagent/drink/milk = 30)
...
/obj/item/reagent_containers/food/drinks/small_milk_choc
	...
	center_of_mass = "x=16;y=9"
	reagents_volume = 30
	reagents = list(/datum/reagent/drink/milk/chocolate = 30)
...
/obj/item/reagent_containers/food/drinks/coffee
	...
	reagents = list(/datum/reagent/drink/coffee = 30)
...
/obj/item/reagent_containers/food/drinks/ice
	...
	base_name = "cup"
	base_icon = "cup"
	reagents = list(/datum/reagent/drink/ice = 30)
...
/obj/item/reagent_containers/food/drinks/h_chocolate
	...
	base_name = "cup"
	base_icon = "cup"
	reagents = list(/datum/reagent/drink/hot_coco = 30)
...
/obj/item/reagent_containers/food/drinks/dry_ramen
	...
	filling_states = "100"
	base_icon = "cup"
	reagents = list(/datum/reagent/drink/dry_ramen = 30)
...
/obj/item/reagent_containers/food/drinks/flask/vacuumflask/use_tool(obj/item/attacking_item, mob/user)
	if (istype(attacking_item, /obj/item/reagent_containers/food/drinks/flask/flask_cup))
		if (cup)
			...
			return TRUE
		if (attacking_item.reagents.total_volume + reagents.total_volume > reagents_volume)
...
/obj/item/reagent_containers/food/drinks/tea
	abstract_type = /obj/item/reagent_containers/food/drinks/tea
	icon_state = "coffee"
	item_state = "coffee"
